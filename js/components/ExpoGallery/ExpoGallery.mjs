...
let html_fragment = await fetch(import.meta.resolve("./ExpoGallery.html"), { mode: "cors" }).then(data => data.text());
let stylerules = await fetch(import.meta.resolve("./ExpoGallery.css"), { mode: "cors" }).then(data => data.text());
